...
import org.videolan.vlc.interfaces.IPlaybackSettingsController.IPlaybackSettingsController;
...
public class VideoPlayerActivityImpl implements IVLCVout.Callback,
...
//            Log.d(TAG, "MediaRouter information : " + mMediaRouter  .toString());
        ...
        if (!AndroidUtil.isJellyBeanOrLater()) {
            mSysTime = (TextView) findViewById(org.ling.videolib.R.id.player_overlay_systime);
            mBattery = (TextView) findViewById(org.ling.videolib.R.id.player_overlay_battery);
        }
        ...
        activity.setRequestedOrientation(getScreenOrientation(mScreenOrientation));
    ...
    public  VideoPlayerActivityImpl(Activity act){
        activity = act;
     ...
     */
        ...
        private View.OnClickListener mBtSaveListener = new View.OnClickListener() {
            @Override
