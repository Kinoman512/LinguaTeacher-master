...
public class VLCApplication extends Application {
    ...
    public static void  setInst(MyApplication inst){
        mSettings = PreferenceManager.getDefaultSharedPreferences(inst);
        instance = inst;
...
//        instance = this;
        ...
        AudioUtil.prepareCacheFolder(inst);

        sTV = AndroidDevices.isAndroidTv() || !AndroidDevices.hasTsp();

        if (!VLCInstance.testCompatibleCPU(inst))
            return;
